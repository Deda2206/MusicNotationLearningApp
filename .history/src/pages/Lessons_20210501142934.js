    ...
    return (
      ...
      <div>
        ...
        <header class="header">
          ...
          <p2>On the stave lines and in the spaces between these lines, notes are place to create melodies. This happens because each line and space is a representation of a specific note on the scale.<br/> The basic scale is <strong>A</strong> , <strong>B</strong>, <strong>C</strong>, <strong>D</strong>, <strong>E</strong>, <strong>F</strong>, <strong>G</strong>. However, these note's names and where they are located on the stave depends on what key the clef is in.</p2>
          <p3> <br/>The keys for any clef follow a specific pattern: <br/>
