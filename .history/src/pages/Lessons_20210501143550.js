      ...
      <div>
        ...
        <header class="header">
          ...
          <p3> <br/><br/>The keys for any clef follow a specific pattern: <br/>
            ...
            Now there are a few rules and changes to note names associated with the different keys so the next step is to break down each clef and look at each indiviual key in detail.<br/>
          </p3>
          </div>
      </div>
    );
